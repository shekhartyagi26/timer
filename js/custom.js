...
$.contactButtons({
  ...
  buttons : {
    ...
    'linkedin':   { class: 'linkedin', use: true, link: 'https://www.linkedin.com/' },
    ...
    'twitter':    { class: 'twitter',  use: true, icon: 'twitter',     link: 'https://twitter.com/login', title: 'Follow on Twitter' },
